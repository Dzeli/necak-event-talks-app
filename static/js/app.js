...
const themeToggleSvg = document.getElementById('theme-toggle-svg');
...
function setupThemeToggle() {
    ...
    themeToggleBtn.addEventListener('click', () => {
        const currentIsLight = document.body.classList.toggle('light-theme');
...
function updateThemeUI(isLight) {
    if (isLight) {
        ...
        // Moon icon for light mode switch
        themeToggleSvg.innerHTML = `
